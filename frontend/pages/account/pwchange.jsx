import { Box, Button, Container, CssBaseline, Divider, TextField, ThemeProvider, Typography } from "@mui/material"
...
export default function Pwchange() {
    ...
    const handleSubmit = async event => {
        ...
        if (!CommonValidator.validate("currentPassword", input.get("currentPassword"))) {
            alert(CommonValidator.password.message)
            return
        }

        if (!CommonValidator.validate("newPassword", input.get("newPassword"))) {
            alert(CommonValidator.password.message)
            return
        }
